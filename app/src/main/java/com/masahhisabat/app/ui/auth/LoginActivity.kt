...
class LoginActivity : AppCompatActivity() {
    ...
    private fun applyLoginTheme() {
        ...
        binding.usernameInput.setTextColor(getColor(if (night) R.color.night_text else R.color.day_text))
        binding.usernameInput.setHintTextColor(getColor(R.color.day_text_secondary))
        binding.passwordInput.setTextColor(getColor(if (night) R.color.night_text else R.color.day_text))
        binding.passwordInput.setHintTextColor(getColor(R.color.day_text_secondary))
